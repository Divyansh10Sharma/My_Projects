...
const isDarkMood = localStorage.getItem('darkMood') === 'true';

// Function to set the dark mode state and update the UI
...
// Set the initial dark mode based on the Stared preference
